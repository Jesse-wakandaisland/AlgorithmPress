...
const NaraUI = (function() {
    ...
    const autoDetectElements = function(rootElement = document.body) {
        ...
        const uiSelectors = {
            ...
            // API Hub specific elements
            apiHubSidebar: {
                selector: '.nara-glass-sidebar',
                options: { glassStrength: 0.9, reflectionStrength: 0.7, priority: 10, dynamicTextColor: true, alwaysOn: true } // Keep sidebar always glassy
            },
            apiHubMainContent: {
                selector: '.nara-glass-main-content', // This might be too broad, could target specific panels within main
                options: { glassStrength: 0.85, reflectionStrength: 0.5, priority: 5, alwaysOn: true } // Keep main content area always glassy
            },
            apiHubModals: {
                selector: '.api-hub-modal-content', // Add this class to React modal content divs
                options: { glassStrength: 0.95, reflectionStrength: 0.8, priority: 15, dynamicTextColor: false }
            }
        };
